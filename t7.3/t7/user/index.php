        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="auth/register.php" class="bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition duration-300 text-lg font-semibold">
                        Get Started Now
                    </a>
                    <div class="dropdown">
    ...
    <main>
        ...
        <section id="home" class="hero-pattern py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex justify-center space-x-4">
                    ...
                    <a href="#how-it-works" class="bg-white text-blue-600 px-8 py-3 rounded-full hover:bg-gray-50 transition duration-300 text-lg font-semibold border border-blue-600">
                        Learn More
                    </a>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <p class="text-gray-600">Get paid immediately after completing surveys. No waiting periods or minimum thresholds.</p>
                    </div>
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        <div class="text-blue-600 text-4xl mb-4">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-gray-50 p-6 rounded-xl">
                        ...
                        <p class="text-gray-600 mb-4">"I've earned over $500 in my spare time. The surveys are interesting and the payment process is smooth."</p>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl">
                        ...
                        <p class="text-gray-600 mb-4">"Great platform for earning extra income. The surveys are well-designed and payments are always on time."</p>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl">
                        ...
                        <p class="text-gray-600 mb-4">"I love how flexible it is. I can take surveys whenever I want, and the earnings add up quickly."</p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="bg-white p-6 rounded-xl shadow-sm">
                        ...
                        <p class="text-gray-600">Earnings vary based on survey length and complexity. Most surveys pay between $1-$5, and active surveyors typically earn $50-$200 per month.</p>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm">
                        <h3 class="text-lg font-semibold mb-2">How do I get paid?</h3>
                        <p class="text-gray-600">Payments are processed instantly through our secure payment system. You can withdraw your earnings at any time.</p>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm">
                        <h3 class="text-lg font-semibold mb-2">How often will I receive surveys?</h3>
                        <p class="text-gray-600">New surveys are available daily. The number of surveys you receive depends on your profile and market research needs.</p>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm">
                        <h3 class="text-lg font-semibold mb-2">Is my information secure?</h3>
                        <p class="text-gray-600">Yes, we use industry-standard encryption and security measures to protect your personal information.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-blue-600">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-xl text-blue-100 mb-8">Join thousands of surveyors who are already earning with TaskBuddy.</p>
                <a href="auth/register.php" class="bg-white text-blue-600 px-8 py-3 rounded-full hover:bg-gray-100 transition duration-300 text-lg font-semibold inline-block">
                    Join Now
                </a>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <a href="../Admin/admindashboard.php" class="inline-flex items-center text-blue-600 hover:text-blue-700">
                    ...
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <a href="../Admin/manage_users.php" class="inline-flex items-center text-blue-600 hover:text-blue-700">
                    ...
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <a href="../Admin/manage_surveys.php" class="inline-flex items-center text-blue-600 hover:text-blue-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <a href="../Admin/admin_withdrawals.php" class="inline-flex items-center text-blue-600 hover:text-blue-700">
                    ...
                    <div class="feature-card bg-white p-6 rounded-xl shadow-lg">
                        ...
                        <a href="../Admin/create_new_admin.php" class="inline-flex items-center text-blue-600 hover:text-blue-700">
