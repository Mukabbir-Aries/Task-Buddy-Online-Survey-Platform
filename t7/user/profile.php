...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmtUpdate->execute()) {
        ...
        $updateMessageClass = "text-green-600 font-semibold mb-4";
    } else {
        $updateMessage = "Error updating profile: " . $stmtUpdate->errorInfo()[2];
        $updateMessageClass = "text-red-600 font-semibold mb-4";
    }
}
?>
<!DOCTYPE html>
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-8">
                ...
                <?php if (!empty($updateMessage)): ?>
                    <p class="<?php echo $updateMessageClass; ?>"><?php echo htmlspecialchars($updateMessage); ?></p>
                <?php endif; ?>
