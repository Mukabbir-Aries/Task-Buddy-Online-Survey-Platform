...
if (!isset($_SESSION['user_id'])) {
    header("Location: ../main.html/auth/login.php");
    exit();
}
    ...
    <div class="flex h-screen">
        ...
        <aside class="bg-blue-800 text-white w-64 p-6 shadow-lg">
            ...
            <nav>
                <ul class="space-y-3">
                    ...
                    <li>
                        <a href="../user/profile.php" class="sidebar-link flex items-center gap-3 p-3 rounded-lg hover:bg-blue-700">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="max-w-7xl mx-auto">
                <!-- Welcome Section -->
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-800">Welcome back, <?php echo htmlspecialchars($_SESSION['username']); ?>!</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="card bg-white p-6 rounded-xl shadow-md">
                        ...
                        <p class="text-2xl font-bold text-gray-800">$<?php echo number_format($total_withdrawn, 2); ?></p>
                        <div class="mt-2 text-sm text-gray-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="card bg-white p-6 rounded-xl shadow-md">
                        ...
                        <a href="../surveys/participate_survey.php" class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                    ...
                    <div class="card bg-white p-6 rounded-xl shadow-md">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a href="../withdrawals/withdraw.php" class="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                                <i class="fas fa-money-bill-wave"></i>
                                Withdraw Now
                            </a>
                            <a href="../withdrawals/withdraw_history.php" class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                                <i class="fas fa-history"></i>
                                View History
                            </a>
                        </div>
                    ...
                    <div class="card bg-white p-6 rounded-xl shadow-md">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a href="../tickets/open_ticket.php" class="inline-flex items-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors">
                                <i class="fas fa-ticket-alt"></i>
                                Open Ticket
                            </a>
                            <a href="../tickets/ticket_history.php" class="inline-flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors">
                                <i class="fas fa-list"></i>
                                View Tickets
                            </a>
                        </div>
